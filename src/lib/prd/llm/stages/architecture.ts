...
- dataModel.relationships: the edges between entities (from, to, kind: one-to-one/one-to-many/many-to-many, optional description). BOTH endpoints of every relationship MUST be names of entities you declared above — a relationship to an undeclared entity is a fatal error.
